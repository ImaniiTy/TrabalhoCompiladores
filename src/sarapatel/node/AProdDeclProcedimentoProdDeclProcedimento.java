...
public final class AProdDeclProcedimentoProdDeclProcedimento extends PProdDeclProcedimento
{
    private TPartida _partida_;
    private TDeclProcedimento _declProcedimento_;
    ...
    public AProdDeclProcedimentoProdDeclProcedimento(
        @SuppressWarnings("hiding") TPartida _partida_,
        @SuppressWarnings("hiding") TDeclProcedimento _declProcedimento_,
        ...
        @SuppressWarnings("hiding") PComando _comando_)
    {
        ...
        setDeclProcedimento(_declProcedimento_);
    ...
    public Object clone()
    {
        return new AProdDeclProcedimentoProdDeclProcedimento(
            cloneNode(this._partida_),
            cloneNode(this._declProcedimento_),
    ...
    {
        ((Analysis) sw).caseAProdDeclProcedimentoProdDeclProcedimento(this);
    }

    public TPartida getPartida()
    {
        return this._partida_;
    }

    public void setPartida(TPartida node)
    {
        if(this._partida_ != null)
        {
            this._partida_.parent(null);
        }
    ...
    public TDeclProcedimento getDeclProcedimento()
    {
        return this._declProcedimento_;
    }

    public void setDeclProcedimento(TDeclProcedimento node)
    {
        if(this._declProcedimento_ != null)
        {
            this._declProcedimento_.parent(null);
        }
    ...
    {
        return ""
            + toString(this._partida_)
            + toString(this._declProcedimento_)
    ...
    {
        // Remove child
        if(this._partida_ == child)
        {
            this._partida_ = null;
            return;
        }

        if(this._declProcedimento_ == child)
        {
            this._declProcedimento_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._partida_ == oldChild)
        {
            setPartida((TPartida) newChild);
            return;
        }

        if(this._declProcedimento_ == oldChild)
        {
            setDeclProcedimento((TDeclProcedimento) newChild);
            return;
        }
