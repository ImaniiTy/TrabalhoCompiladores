...
public final class AChamadaChamadaProcedimento extends PChamadaProcedimento
{
    private TId _id_;
    private final LinkedList<PExp> _listaExp_ = new LinkedList<PExp>();

    public AChamadaChamadaProcedimento()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaChamadaProcedimento(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAChamadaChamadaProcedimento(this);
    }
