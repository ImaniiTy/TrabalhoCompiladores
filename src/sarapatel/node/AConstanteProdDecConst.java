...
public final class AConstanteProdDecConst extends PProdDecConst
{
    ...
    public Object clone()
    {
        return new AConstanteProdDecConst(
    ...
    {
        ((Analysis) sw).caseAConstanteProdDecConst(this);
    }
